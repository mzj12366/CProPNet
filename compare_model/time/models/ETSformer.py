...
from compare_model.time.layers.ETSformer_EncDec import EncoderLayer, Encoder, DecoderLayer, Decoder, Transform
...
class ETSformerModel(nn.Module):
    ...
    def __init__(self, configs):
        super(ETSformerModel, self).__init__()
        ...
        self.projection = nn.Linear(configs.d_model * configs.seq_len, configs.model_output_dim)
